...
loggedoutpages: Array<{ title: string, component: any, active: boolean, icon: string, logsOut?: boolean }>;
  ...
  constructor(
    ...
    this.pages = [
	  ...
	  { title: 'Blockchain', component: 'InsurancesPage', active: false, icon: 'contact' },
	  { title: 'Innovation', component: 'InsurancesPage', active: false, icon: 'contact' },
	  { title: 'Economics', component: 'InsurancesPage', active: false, icon: 'contact' },
	  { title: 'Offering', component: 'AccordionListPage', active: false, icon: 'contact' },
	  { title: 'Events', component: 'ConcertCardPage', active: false, icon: 'contact' },
	  { title: 'Samples', component: 'FlashCardPage', active: false, icon: 'contact' },
	  { title: 'Usecases', component: 'InsurancesPage', active: false, icon: 'contact' },
      { title: 'Contact', component: 'ProfileFivePage', active: false, icon: 'contact' },
